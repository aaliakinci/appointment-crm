...
namespace AppointmentCrm.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260823103952_OutboxDeliveryHardening")]
    partial class OutboxDeliveryHardening
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppointmentCrm.Domain.Outbox.NotificationDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AppointmentCrm.Domain.Outbox.OutboxMessage", b =>
                {
                    ...
                    b.HasIndex("ProcessedAtUtc", "FailedAtUtc", "NextAttemptAtUtc", "LockedUntilUtc")
            ...
            modelBuilder.Entity("AppointmentCrm.Domain.Outbox.NotificationDelivery", b =>
                {
                    b.HasOne("AppointmentCrm.Domain.Outbox.OutboxMessage", null)
                        .WithMany()
